...
# --- Ciclo de juego ---
signal game_session_started(project_id: String, is_playtest: bool)
signal game_session_completed(project_id: String, outcome: String, survived_seconds: int, ending_id: String, is_playtest: bool)
signal ending_reached(project_id: String, ending_id: String, survived_seconds: int, is_playtest: bool)
